...
image_folder = 'C:\\Automate\\AI-Automation-Video-Generating\\youtube-autoupload-python\\DataLibrary\\Images\\Love'
...
final_output_path = 'C:\\Automate\\AI-Automation-Video-Generating\\youtube-autoupload-python\\5_images_video.mp4'
